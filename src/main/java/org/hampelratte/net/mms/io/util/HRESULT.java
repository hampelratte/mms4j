...
public class HRESULT {
    ...
    static {
        ...
        hrToHuman.put(0xc00d001a, "The system cannot find the file specified.");
     ...
     *
     * @param hresult
     *            the HRESULT value as integer
     * @return a human readable string or the given hresult, if no translation is available
     */
