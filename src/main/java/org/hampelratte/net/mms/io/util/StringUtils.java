...
public class StringUtils {
    ...
    public static String toHexString(IoBuffer b) {
        return toHexString(b, 8);
    }

    public static String toHexString(IoBuffer b, int bytesPerRow) {
        b.mark();
        byte[] bytes = new byte[b.remaining()];
        b.get(bytes);
        b.reset();
        return toHexString(bytes, bytesPerRow);
    }
