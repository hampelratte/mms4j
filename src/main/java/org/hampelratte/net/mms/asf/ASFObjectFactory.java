...
import org.hampelratte.net.mms.asf.objects.ASFCompatibilityObject;
...
import org.hampelratte.net.mms.asf.objects.ASFPaddingObject;
...
public class ASFObjectFactory {
    ...
    static {
        ...
        guid2Class.put(new GUID("1806D474-CADF-4509-A4BA-9AABCB96AAE8"), ASFPaddingObject.class);
        guid2Class.put(new GUID("26F18B5D-4584-47EC-9F5F-0E651F0452C9"), ASFCompatibilityObject.class);
