...
/**
 * The ReportConnectedFunnel message is sent by the server in
 * response to a {@link ConnectFunnel} (section 2.2.4.18) message sent by
 * the client.
 * 
 * @author <a
...
public class ReportConnectedFunnel extends MMSResponse {
    ...
    /** @param hr A 32-bit field. MUST be set to 0x00000000. */
    ...
    /**
     * @return packetPayloadSize (4 bytes): A 32-bit field. SHOULD be set to
     *         0x00000000. It MUST be ignored by the receiver.
     */
    ...
    /**
     * @param packetPayloadSize (4 bytes): A 32-bit field. SHOULD be set to
     *         0x00000000. It MUST be ignored by the receiver.
     */
    ...
    /**
     * @return funnelName (variable): A variable size array of Unicode
     *         characters. MUST be set to the Unicode character string
     *         "Funnel Of The Gods".
     */
    ...
    /**
     * @param funnelName
     *            (variable): A variable size array of Unicode characters. MUST
     *            be set to the Unicode character string "Funnel Of The Gods".
     */
